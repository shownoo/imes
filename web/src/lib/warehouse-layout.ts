...
export const WAREHOUSE_PLAN = [
  { code: 'WH-MAIN', name: '中心主库' },
  { code: 'WH-BACKUP', name: '战略备库' },
] as const

export const STORAGE_ZONE_PLAN = [
  { code: 'A', warehouseCode: 'WH-MAIN', name: 'A区·抢险类', zoneType: 'DISASTER' },
  { code: 'B', warehouseCode: 'WH-MAIN', name: 'B区·救助类', zoneType: 'RESCUE' },
  { code: 'C', warehouseCode: 'WH-MAIN', name: 'C区·通用类', zoneType: 'GENERAL' },
  { code: 'D', warehouseCode: 'WH-BACKUP', name: 'D区·恒温库', zoneType: 'TEMPERATURE' },
] as const
