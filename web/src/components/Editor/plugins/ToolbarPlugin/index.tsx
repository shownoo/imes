...
import { Divider as UiDivider } from 'components/legacy-button';
...
function Divider(): JSX.Element {
  return <UiDivider className="mx-0.5 h-8" />;
}
  ...
  return (
    ...
    >
      {(style === 'font-family' ? FONT_FAMILY_OPTIONS : FONT_SIZE_OPTIONS).map(
        ([option, text]) => (
          <DropDownItem
            // eslint-disable-next-line tailwindcss/no-custom-classname -- Lexical toolbar uses editor CSS class names
  ...
  return (
    <div className="toolbar">
      ...
      <>
        ...
        <VariablePlugin templateKey={templateKey} />
        <DropdownColorPicker
          disabled={!isEditable}
